...
\usepackage{array} 
\usepackage{cancel}                      % Für Tabellen mit Zeilenumbrüchen in Zellen
\usepackage[english]{babel}	 % Paket für Sprachselektion, in diesem Fall für deutsches Datum etc
...
\usepackage{nameref}					 % for referencing subsections with name instead number
