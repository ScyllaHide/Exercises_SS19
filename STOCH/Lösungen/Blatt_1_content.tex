...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item Höchstens der drei Ereignisse tretten ein.
	\end{enumerate}
...
\begin{proof}
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\begin{align*}
			\emptyset = \bigcup_{n=1}_{\infty \emptyset} \qquad \Meas(\emptyset) = \Meas\left(\bigcup_{n=1}^{\infty}\right) = \sum_{i= 1}^{\infty} \Meas(\emptyset) \le 1.
			\end{align*}
			\item 
		\end{enumerate}
	\end{enumerate}
