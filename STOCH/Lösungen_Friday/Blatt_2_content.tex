...
\begin{lösung}
	\begin{enumerate}
		...
		\begin{align*}
			\P(X=0) = \binom{n}{0}p^0(1-p)^{n-0} = 0.97^5 \approx \ul{0,8587}
		\end{align*}
...
\begin{lösung}
	...
	\begin{itemize}
		...
		\end{align*}
		\item Poisson-Approximation: Dabei wähle $\Omega = \N, \P = \Pois(\lambda = np)$
		\begin{align*}
			\P(X \ge 2) = 1 - \P(X = 1) - \P(X = 0) \approx 0.2642
		\end{align*}
	\end{itemize}
...
\begin{enumerate}
	...
	\item Es sei $\P({k}) = 2^{-k}$. Zeigen Sie, $\P$ ist ein Wahrscheinlichkeitsmaß auf $(\N , \P(\N))$. Geben Sie
...
\begin{lösung}
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\begin{align*}
			\P(X \ge 2) 
			&= \P(\set{\omega \in \Omega : X(\omega) \ge 2})\\
			&= \frac{\abs{\omega \in \Omega : X(\omega \ge 2)}}{\abs{\Omega}}\\
			\P(X \ge 2)
			&= 1 - \P(X<2)\\
			&= \frac{365\mal 364 \cdots (365-n + 1)}{365^n}
			\end{align*} 
			Für $n = 23$ ist $\P(X \ge 2) \approx \frac{1}{2}$.
			\item Für festes Datum: $p = \frac{1}{365}, q \approx 1- p = 1 - \frac{1}{365}$
			\begin{align*}
				\P = 1- q^n = \frac{1}{2} \Longrightarrow \frac{1}{2} = q^n \Longrightarrow n = \frac{\ln \frac{1}{2}}{\ln q} \approx 253 
			\end{align*}
		\end{itemize}
	...
	\end{align*}
	\item \begin{align*}
	\P(L = 3) &= \frac{7}{13} & \P(L = 3) &= \frac{1}{13}\\
	\P(L = 4) &= \frac{2}{13} & \P(L = 3) &= \frac{1}{13}\\
	\P(L = 5) &= \frac{1}{13} & \P(L = 3) &= \frac{1}{13}\\
	\P(L = 6) &= \frac{1}{13} &              &              \\
	\end{align*}
