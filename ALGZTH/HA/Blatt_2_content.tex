...
%%%%%%%%%%%%%%%%%%%% Aufgabe 2 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{H24}
Find the splitting field and determine the degree for $f \in \Q$: 
\begin{enumerate}
	\item $f = X^2 + X +1$
	\item $f = X^3 + X^2 + X + 1$
	\item $f = X^4 + X^3 + X^2 + 1$
\end{enumerate}
...
\begin{lösung}
	\begin{enumerate}
		...
		\begin{align*}
			...
			&II) ab = 1 \quad \Rightarrow (\frac{1}{2} + a)(\frac{1}{2}-a)\\
			&= \frac{1}{\frac{3}{4}} \quad \Rightarrow -a^2 = \frac{3}{4}\\
		\end{align*}
		So the roots are:
		\begin{align*}
			X_{1/2} = \frac{1}{2} \pm \frac{\sqrt{3}\ii}{2}
		\end{align*}
	\end{enumerate}
\end{lösung}
