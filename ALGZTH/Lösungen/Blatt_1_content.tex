...
\begin{proof}
	...
	\begin{enumerate}
		...
		\end{enumerate}
		\item Mit \ref{sec_V3} gilt $\R(1+\ii) = \R(\ii) = \C$. Deshalb ist $[\R(1+\ii)\colon \R] = 2$, d.h. das Minimalpolynom von $1+\ii$ über $\R$ hat Grad 2. Außerdem ist $f$ normiert und $1+\ii$ ist Nullstelle von $f$. Da $f$ Grad 2 hat, schließen wir, dass $f$ das Minimalpolynom von $1+\ii$ über $\R$ ist.
	\end{enumerate}
\end{proof}
